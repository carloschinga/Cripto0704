...
@WebServlet(name = "LogueoToledo", urlPatterns = { "/oauth2callback" })
public class LogueoToledo extends HttpServlet {

    private static final String CLIENT_ID = "305448852455-001c4k6spf8lq7h5a8svcuad6rb5phpo.apps.googleusercontent.com";
