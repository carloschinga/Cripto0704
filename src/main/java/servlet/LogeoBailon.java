...
@WebServlet(name = "LogeoBailon", urlPatterns = {"/logeobailon"})
public class LogeoBailon extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            GoogleIdTokenVerifier verifier = new GoogleIdTokenVerifier.Builder(new NetHttpTransport(), new GsonFactory())
                    .setAudience(Collections.singletonList("872730400534-4josm5bcq4enqvlfkf8l7ll7ln76rics.apps.googleusercontent.com"))
                    .build();
